<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adschreview.aspx.cs" Inherits="Rexorce.Adschreview" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Admin Review Schedule</title>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-5">
                                ...
                                <div class="grid-container">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="waste_Id" DataSourceID="SqlDataSource1" OnRowCommand="GridView1_RowCommand" CssClass="grid-view">
